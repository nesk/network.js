 ...
 * @property {string|function} [endpoint=./network.php] The URL to your endpoint, can be a string or a function which returns a string.
...
export default class HttpModule extends EventDispatcher {
     ...
     */
    /**
     * Process and return the current set of settings.
     * @public
    ...
    settings(settings = null) {
        ...
        if (isPlainObject(settings)) {
            ...
            // If the endpoint is a function, define the endpoint as a getter calling this function.
            if (isFunction(this._settings.endpoint)) {
                Object.defineProperty(this._settings, 'endpoint', {
                    configurable: true,
                    get: (...args) => this._settings.endpoint(this._moduleName, ...args),
                });
            }
